    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="text-center mb-8">
            ...
            <div class="flex items-center justify-center space-x-3 mb-2">
                ...
                <h1 class="text-3xl font-bold text-text">Edit Film</h1>
            </div>
            <p class="text-text/70">Update film information</p>
        </div>
        ...
        <div class="bg-secondary p-8 rounded-xl border border-secondary/50 shadow-lg">
            ...
            <form action="{{ route('films.update', $film->id) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
        @csrf
        @method('PUT')
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="text" id="title" name="title" value="{{ old('title', $film->title) }}" 
                                   ...
                                   placeholder="e.g. Interstellar" required>
            ...
            <div>
                            ...
                            <input type="number" id="release_year" name="release_year" value="{{ old('release_year', $film->release_year) }}" 
                                   class="w-full px-4 py-3 bg-background border border-secondary/50 rounded-lg text-text placeholder-text/50 focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all duration-200"
            ...
            <div>
                            ...
                            <input type="number" id="duration" name="duration" value="{{ old('duration', $film->duration) }}" 
                                   class="w-full px-4 py-3 bg-background border border-secondary/50 rounded-lg text-text placeholder-text/50 focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all duration-200"
            ...
            <div>
                            ...
                            <input type="text" id="language" name="language" value="{{ old('language', $film->language) }}" 
                                   class="w-full px-4 py-3 bg-background border border-secondary/50 rounded-lg text-text placeholder-text/50 focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all duration-200"
            ...
            <div>
                            ...
                            <input type="text" id="director" name="director" value="{{ old('director', $film->director) }}" 
                                   class="w-full px-4 py-3 bg-background border border-secondary/50 rounded-lg text-text placeholder-text/50 focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all duration-200"
            ...
            <div>
                            ...
                            <input type="text" id="cast" name="cast" value="{{ old('cast', $film->cast) }}" 
                                   class="w-full px-4 py-3 bg-background border border-secondary/50 rounded-lg text-text placeholder-text/50 focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all duration-200"
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="4" 
                                  ...
                                  placeholder="Write film synopsis here...">{{ old('description', $film->description) }}</textarea>
                    </div>
        </div>
                ...
                <div class="space-y-6 pt-6 border-t border-secondary/50">
                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-4">
                            <div class="relative">
                                <input type="color" id="overlay_color" name="overlay_color" value="{{ old('overlay_color', $film->overlay_color ?? '#000000') }}" 
                ...
                <div class="space-y-6 pt-6 border-t border-secondary/50">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                        ...
                        <input type="checkbox" name="genre_ids[]" value="{{ $genre->id }}"
                            {{ in_array($genre->id, old('genre_ids', $film->genres->pluck('id')->toArray())) ? 'checked' : '' }}
            ...
            <div>
                            ...
                            @if($film->logo)
                                <div class="mt-3 p-3 bg-background rounded-lg border border-secondary/50">
                                    <p class="text-text/70 text-sm mb-2">Current Logo:</p>
                                    <img src="{{ asset('storage/' . $film->logo) }}" alt="Current Logo" class="w-full h-32 object-contain rounded">
                                </div>
                @endif
            </div>
            ...
            <div>
                            ...
                            @if($film->poster)
                                <div class="mt-3 p-3 bg-background rounded-lg border border-secondary/50">
                                    <p class="text-text/70 text-sm mb-2">Current Poster:</p>
                                    <img src="{{ asset('storage/' . $film->poster) }}" alt="Current Poster" class="w-full h-32 object-contain rounded">
                                </div>
                @endif
            </div>
            ...
            <div>
                            ...
                            @if($film->background)
                                <div class="mt-3 p-3 bg-background rounded-lg border border-secondary/50">
                                    <p class="text-text/70 text-sm mb-2">Current Background:</p>
                                    <img src="{{ asset('storage/' . $film->background) }}" alt="Current Background" class="w-full h-32 object-contain rounded">
                                </div>
                @endif
                        </div>
            </div>
