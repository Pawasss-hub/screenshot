  <div class="w-full max-w-4xl flex flex-col lg:flex-row bg-white dark:bg-[#161615] shadow-lg rounded-lg overflow-hidden">
    <!-- Left Form Section -->
      ...
      <form method="POST" action="{{ route('register') }}" class="space-y-5">
        ...
        <div>
          ...
          <input
            ...
            required
            autofocus
            class="w-full px-4 py-2 border rounded-sm dark:bg-[#0a0a0a] dark:border-[#3E3E3A] dark:text-white @error('name') border-red-500 @enderror"
          />
          @error('name')
        ...
        <div>
          ...
          <input
            ...
            required
            class="w-full px-4 py-2 border rounded-sm dark:bg-[#0a0a0a] dark:border-[#3E3E3A] dark:text-white"
          />
        </div>
        ...
        <div class="text-center">
          <p class="text-sm">
            ...
            <a href="{{ route('login') }}" class="text-[#1b1b18] font-semibold">Log In</a>
          </p>
        </div>
      </form>
    </div>
