...
<head>
    ...
    <title>Create Tag - Admin Dashboard</title>
    ...
    <div class="max-w-md w-full">
        ...
        <div class="text-center mb-8">
            ...
            <div class="flex items-center justify-center space-x-3 mb-2">
                ...
                <h1 class="text-2xl font-bold text-text">Create New Tag</h1>
            </div>
            <p class="text-text/70">Add a new tag to categorize content</p>
        </div>
        ...
        <div class="bg-secondary p-8 rounded-xl border border-secondary/50 shadow-lg">
            ...
            <form action="{{ route('tags.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <p class="text-text/50 text-sm mt-2">Use descriptive names for better categorization</p>
                </div>
        ...
        <div class="mt-6 bg-primary/10 border border-primary/20 rounded-lg p-4">
            <div class="flex items-start">
                ...
                <div>
                    <h3 class="text-sm font-medium text-text mb-2">Tips for Creating Tags</h3>
                    <ul class="text-sm text-text/70 space-y-1">
                        ...
                        <li>• Check for existing tags to avoid duplicates</li>
                    </ul>
                </div>
                </div>
            </div>
